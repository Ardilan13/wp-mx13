		...
		echo '<div class="theplus-panel-col theplus-panel-col-65">';
			...
			echo '<div class="theplus-panel-sec theplus-p-20 theplus-welcome-changelog theplus-mb-8">';
				...
				echo '<div class="theplus-changelog-list">';
					echo '<div class="changelog-date">June 29, 2023 <span class="changelog-version">Lite Version 5.2.9</span></div>';
						echo '<ul class="changelog-list">';
							echo '<li>'.esc_html__('Update : Contact Form 7 : Default Select Form & Default error massage', 'tpebl').'</li>';
							echo '<li>'.esc_html__('Update : Caldera Forms : Default Select Form', 'tpebl').'</li>';
				...
				echo '<div class="theplus-changelog-list">';
					echo '<div class="changelog-date">June 29, 2023 <span class="changelog-version">Pro Version 5.2.10</span></div>';
						echo '<ul class="changelog-list">';	
							echo '<li>'.esc_html__('Added : Dynamic Listing : Custom Field for ACF Repeater key', 'tpebl').'</li>';
							echo '<li>'.esc_html__('Update : Post Comment : Add Controller For Dynamic Content', 'tpebl').'</li>';
							echo '<li>'.esc_html__('Fix : Process Steps : Controller Condition Improvement', 'tpebl').'</li>';
						echo '</ul>';					
				echo '</div>';
